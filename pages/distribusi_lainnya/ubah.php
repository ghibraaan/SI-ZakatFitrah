                ...
                <div class="form-card-2">
                    <form method="POST">
                        ...
                        if(isset($_GET['id_mustahiklainnya'])) {
                            $sqlEdit = $koneksi->query("select * from mustahik_lainnya where id_mustahiklainnya='$_GET[id_mustahiklainnya]'");
                    ...
                    if ($Simpan) {
                        ...
                        $sql = $koneksi->query("update mustahik_lainnya set nama='$nama', kategori='$kategori', hak='$hak' where id_mustahiklainnya='$id_mustahiklainnya'");
