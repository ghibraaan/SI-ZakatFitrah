                ...
                <div class="table-card-2">
                    <div class="table-container">
                        <table class="content-table">
                            ...
                            $sql = $koneksi->query("select * from pembayaran_zakat");

                            if(isset($_GET['search'])) {
                                $sql = $koneksi->query("select * from pembayaran_zakat WHERE nama_muzakki LIKE '%".$_GET['search']."%' OR keterangan LIKE '%".$_GET['search']."%'");
                            }
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 130px;" align="center">
                                        <a href='form_bayar.php?id_bayar=<?php echo $data['id_bayar'] ?>' class="btn-pay">Bayar</a>
                                    </td>
                                </tr>
